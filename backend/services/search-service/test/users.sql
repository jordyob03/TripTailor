...
(2, 'user2', 'user2@example.com', 'password2', '1992-02-15', 'Jane Smith', 'Canada', ARRAY['English', 'French'], ARRAY['hiking', 'adventure'], ARRAY[103, 104]),
(3, 'user3', 'user3@example.com', 'password3', '1995-03-22', 'Alice Brown', 'UK', ARRAY['English'], ARRAY['art', 'culture'], ARRAY[105, 106]),
